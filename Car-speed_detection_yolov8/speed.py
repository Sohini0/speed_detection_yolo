...
#        print(row)
    ...
    cv2.line(frame,(267,cy1),(814,cy1),(255,255,255),1)
    cv2.putText(frame,('L1'),(274,318),cv2.FONT_HERSHEY_COMPLEX,0.8,(0,255,255),2)
    cv2.line(frame,(167,cy2),(932,cy2),(255,255,255),1)
    cv2.putText(frame,('L2'),(181,363),cv2.FONT_HERSHEY_COMPLEX,0.8,(0,255,255),2)
    d = (len(counter))
